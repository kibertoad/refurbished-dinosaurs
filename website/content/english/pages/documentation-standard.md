...
spec/
  ...
  index/           by-kind.md, by-area.md, by-status.md, references.md, generated by the check script
...
- every glossary file is named after the term in its `#` heading, and no two terms differ only in case;
